...
#python -u train.py model=qwen exp_name=qwen05_20240419 trainer=BasicTrainer n_epochs=4
...
python -u train.py model=pythia1b exp_name=pythia1b_supreject_20240419 trainer=BasicTrainer n_epochs=4 train_supervise=rejected